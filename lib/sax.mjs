...
import { error, XML_ERR_ERROR, xmlCreatePushParserCtxt, xmlCtxtSetErrorHandler, xmlCtxtSetOptions, XmlError, xmlFreeSaxParserCtxt, xmlParseChunk, xmlStopParser, } from './libxml2.mjs';
...
const typedArrayTag = Object.getOwnPropertyDescriptor(Object.getPrototypeOf(Uint8Array.prototype), Symbol.toStringTag);
function isUint8Array(chunk) {
 ...
 */
let XmlSaxParser = (() => {
    let _classDecorators = [disposeBy(freeSaxParser)];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = XmlDisposable;
    var XmlSaxParser = _classThis = class extends _classSuper {
        constructor() {
            super(...arguments);
        ...
        static create(handler, options = {}) {
            if (options.encoding && options.encoding !== 'utf-8') {
                throw new XmlError('Setting an encoding is not supported, the parser detects it from the document');
            }
            if (options.option && (options.option & ParseOption.XML_PARSE_DTDVALID) !== 0) {
                throw new XmlError('DTD validation is not supported, it needs the document tree');
            }
    ...
    __setFunctionName(_classThis, "XmlSaxParser");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        XmlSaxParser = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return XmlSaxParser = _classThis;
})();
export { XmlSaxParser };
